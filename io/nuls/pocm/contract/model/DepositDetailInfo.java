...
public class DepositDetailInfo {
    ...
    public String toString(){
        return "{depositNumber:"+depositNumber +",miningAddress:"+miningAddress+",depositAmount:"+depositAmount+", depositTime:" + depositTime+" depositPolicy:"+getDepositPolicy().toString()+" }";
    }
}
